...
public class BirSekil4AdActivity extends AppCompatActivity {

    TextView oyun1S4Apuan;
    ImageView oyun1S4Acan1,oyun1S4Acan2,oyun1S4Acan3,oyun1S4Aresim;
    LinearLayout oyun1S4ALinear;
    Context context=this;
    DataHelper dataHelper=new DataHelper(context);
    Random random=new Random();
    int puan=0;
    int can=3;
    int sekilad,variant2,variant3,variant4,forsayi;
    int sayi;
    private AdView mAdView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bir_sekil4_ad);
        init();
        ...
        oyun1S4Apuan.setText(getString(R.string.puan_yazi)+" "+puan);
        sayi=sekilArray1.length;
        dataHelper.saveDataInt("oyun1S4Apuan",0);
        esasFunk(sekilArray1,adArray1);

    }

    public void init(){
        oyun1S4Apuan=(TextView) findViewById(R.id.oyun1S4Apuan);
        oyun1S4Acan1=(ImageView) findViewById(R.id.oyun1S4Acan1);
        oyun1S4Acan2=(ImageView) findViewById(R.id.oyun1S4Acan2);
        oyun1S4Acan3=(ImageView) findViewById(R.id.oyun1S4Acan3);
        oyun1S4Aresim=(ImageView) findViewById(R.id.oyun1S4Aresim);
        oyun1S4ALinear=(LinearLayout) findViewById(R.id.oyun1S4ALinear);
    ...
    public void esasFunk(final int[] sekilArray, final String[] adArray){
        ...
        rand(sayi);
        oyun1S4Aresim.setImageDrawable(this.getResources().getDrawable(sekilArray[sekilad]));
        ...
        for (int i=0;i<3-forsayi;i++){
            ...
            btn1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (can==2){
                        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(oyun1S4Acan1,View.ROTATION_Y,180f);
                        objectAnimator.setDuration(500);
                        objectAnimator.start();
                        oyun1S4Acan1.setImageDrawable(getResources().getDrawable(R.drawable.ic_favorite_black_24dp));


                    }else if(can==1){
                        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(oyun1S4Acan2,View.ROTATION_Y,180f);
                        objectAnimator.setDuration(500);
                        objectAnimator.start();
                        oyun1S4Acan2.setImageDrawable(getResources().getDrawable(R.drawable.ic_favorite_black_24dp));

                    }else if (can==0){
                        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(oyun1S4Acan3,View.ROTATION_Y,180f);
                        objectAnimator.setDuration(500);
                        objectAnimator.start();
                        oyun1S4Acan3.setImageDrawable(getResources().getDrawable(R.drawable.ic_favorite_black_24dp));
                    }
                    if (can==0){
                        ...
                        handler1.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                startActivity(new Intent(context,BirSekil4AdResultActivity.class));
                                finish();
        ...
        btn2.setTextSize(16);
        btn2.setText(adArray[sekilad]);
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                puan++;
                dataHelper.saveDataInt("oyun1S4Apuan",puan);
                oyun1S4Apuan.setText(getString(R.string.puan_yazi)+" "+puan);
